...
import type { ContentUndoData } from "./UndoData";
// ----------------------------------------------------------------------------- //
...
export class HistoryManager {
    ...
    push(command: ExecutedCommand) {
        ...
        if (
            ...
            if (
                ...
                (last.undoData as ContentUndoData).newContent =
                    (command.undoData as ContentUndoData).newContent;
    ...
    getUndoHistory(): ExecutedCommand[] {
        return [...this.undoStack];
    }

    getRedoHistory(): ExecutedCommand[] {
