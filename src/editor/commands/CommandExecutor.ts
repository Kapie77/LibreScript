...
// applyChangeBlockType //
public applyChangeBlockType(

    command: ChangeBlockTypeCommand

) {

    return this.model.changeParagraphType(
...
// =======================================================
    execute(
        ...
        switch (command.type) {
            ...
            // CHANGE BLOCK TYPE //
            // (antigo: CHANGE PARAGRAPH TYPE) //
            case "CHANGE_BLOCK_TYPE": {

                const result =
                    this.applyChangeBlockType(command);
